let dbConfig,Sequelize;_69f‍.x([["sequelize",()=>sequelize],["Sequelize",()=>Sequelize],["default",()=>_69f‍.o]]);_69f‍.w("../config",[["database",["dbConfig"],function(v){dbConfig=v}]]);_69f‍.w("sequelize",[["Sequelize",["Sequelize"],function(v){Sequelize=v}]]);
...
sequelize.afterConnect(async (conn, _opt) => {
    ...
    try {
        ...
        _69f‍.g.console.error('Error seteando esquema', err)
    }
})



_69f‍.d({ sequelize, Sequelize });